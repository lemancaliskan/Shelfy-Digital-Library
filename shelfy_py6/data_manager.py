...
class JSONManager:
    ...
    def get_filtered_books(self, search_query=None, category=None, subcategory=None, status=None, stock=None,
        ...
        if list_type and list_type not in ["all_list", "Tümü", "Tüm Kitaplar", "📚 Tüm Kitaplar", "📚 All Books",
                                           "All Lists"]:
            target_list = "Favorilerim" if list_type in ["favorites", "Favorilerim", "⭐ Favorilerim", "⭐ Favorites",
                                                         "Favorites"] else list_type
